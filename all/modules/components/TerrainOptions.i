...
%attributeval(massif::TerrainOptions, massif::Color, FogColor, getFogColor, setFogColor)
%attribute(massif::TerrainOptions, float, FogStartDistance, getFogStartDistance, setFogStartDistance)
%attribute(massif::TerrainOptions, float, FogDistance, getFogDistance, setFogDistance)
