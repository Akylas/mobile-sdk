...
namespace massif {
    ...
    void GpuFrameProfiler::logInterval() {
        ...
        Log::Infof("PROF GPU: %d frames, %d dropped (disjoint), %d sections untimed | sky %.1f background %.1f prelude %.1f prepare %.1f cover %.1f drape %.1f layers %.1f layers3D %.1f billboards %.1f shadowCast %.1f shadowMask %.1f groundAO %.1f total %.1f",
            ...
            avgMs[SECTION_DRAPE], avgMs[SECTION_LAYERS], avgMs[SECTION_LAYERS3D], avgMs[SECTION_BILLBOARDS], avgMs[SECTION_SHADOWCAST], avgMs[SECTION_SHADOWMASK], avgMs[SECTION_GROUNDAO],
            totalMs);
