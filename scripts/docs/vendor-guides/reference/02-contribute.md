...
Massif Maps is open source. Contributions are welcome.
...
Massif Maps documentation is located in ```docs/```. The published site is built from `website/`. Just follow the instructions described in [contributing code](#contributing-code).
...
Open a pull request against [massif-maps/MassifMaps](https://github.com/massif-maps/MassifMaps).