...
+ (void)applyHour:(float)hourUtc light:(NTLightOptions *)light sky:(NTSkyOptions *)sky
    ...
    [light setSunColor:[[NTColor alloc] initWithR:255
                                                g:(int)(255 - 90 * warm)
                                                b:(int)(255 - 190 * warm)
                                                a:255]];
    ...
    [sky setSkyColor:[[NTColor alloc] initWithR:skyR g:skyG b:skyB a:255]];
    [sky setHorizonColor:[[NTColor alloc] initWithR:horR g:horG b:horB a:255]];
    [sky setGroundColor:[[NTColor alloc] initWithR:(int)(horR * 0.8) g:(int)(horG * 0.8) b:(int)(horB * 0.8) a:255]];
...
+ (void)sunVectorAt:(float)hourUtc lat:(double)lat lon:(double)lon out:(double *)out {
    NTLightOptions *probe = [[NTLightOptions alloc] init];
