...
@implementation DemoStarCatalogue
 ...
 * stars above - a few well known ones (Ursa Major's plough, Orion, the Southern Cross) rather than
 * all 88 boundaries, which is what makes a sky readable at a glance.
 */
...
/** Java's LinkedHashMap keeps its insertion order; an NSDictionary does not, hence this list. */
+ (NSArray<NSString *> *)figureNames {
    return @[@"Orion", @"Ursa Major", @"Ursa Minor", @"Cassiopeia", @"Cygnus", @"Lyra", @"Aquila",
             @"Scorpius", @"Sagittarius", @"Leo", @"Taurus", @"Gemini", @"Canis Major", @"Bootes",
             @"Crux", @"Centaurus", @"Pegasus", @"Andromeda", @"Auriga", @"Perseus", @"Virgo",
             @"Aries", @"Cepheus", @"Draco", @"Corona Borealis", @"Canis Minor", @"Ophiuchus",
             @"Libra", @"Carina", @"Vela"];
}
